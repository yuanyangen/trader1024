...
//}
//
//func NewATRIndicator(kline *model.BaseLine, period int64) *ATRIndicator {
//	sma := &ATRIndicator{
...
//		return
//	}
//	data_crawler := model.NewKnodesFromAny(dataI)
//
...
//	avg := out[len(out)-1] / data_crawler[0].Close
...
//}
//
//func (sma *ATRIndicator) DoPlot(kline *charts.Line, ratioLine *charts.Line) {
