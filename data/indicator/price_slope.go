...
//}
//
//func NewSlopIndicator(rawLine *model.BaseLine, period int64) *SlopIndicator {
//	slop := &SlopIndicator{
//		inLine:          rawLine,
...
//	}
//
//	out := (data_crawler[1] - data_crawler[0]) / data_crawler[1]
...
//}
//
//func (si *SlopIndicator) DoPlot(kline *charts.Line, ratioLine *charts.Line) {
