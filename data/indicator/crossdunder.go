...
//}
//
//func NewCrossUnderIndicator(kline *model.BaseLine, lineA *indicator_base2.Line, lineB *indicator_base2.Line) *CrossUnderIndicator {
...
//}
//
//func (cou *CrossUnderIndicator) DoPlot(kline *charts.Line, ratioLine *charts.Line) {
