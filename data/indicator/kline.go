...
//}
//
//func NewKLine(name string, t model.LineType) *model.BaseLine {
//	return &KLineIndicator{
//		IndicatorCommon: indicator_base.NewIndicatorCommon(),
//		BaseLine:        model.NewBaseLine(name, t),
//	}
//}
//
...
////	for i, v := range res {
////		newRes[i] = k.nodeToFloat(v.(*model.DataNode))
////	}
////
////	return newRes, nil
////}
...
//}
//
////	func (k *KLineIndicator) GetKnodeByTs(ts int64) (*model.DataNode, error) {
////		vI, err := k.BaseLine.GetByTs(ts)
////		if err != nil || vI == nil {
////			return nil, err
////		}
////		node, ok := vI.(*model.DataNode)
////		if !ok {
...
////}
//
//func (k *KLineIndicator) DoPlot(kline *charts.Line, ratioLine *charts.Line) {
