...
//}
//
//func NewBBANDIndicator(kline *model.BaseLine, period int64) *BBANDIndicator {
...
//	data_crawler, err := bband.kline.GetLastByTsAndCount(ts, bband.erPeriod+1)
//	if err != nil {
...
//		panic("erPeriod empty")
//	}
//	data_crawler, err := l.GetByTs(ts)
//	if err != nil {
//		return 0
//	} else {
//		return data_crawler.GetValue()
//	}
//}
//
//func (bband *BBANDIndicator) DoPlot(kline *charts.Line, ratioLine *charts.Line) {
...
//}
//
//func (bband *BBANDIndicator) doPlotOneLine(kline *charts.Line, l *indicator_base.Line) {
