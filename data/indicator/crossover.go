...
//}
//
//func NewCrossOverIndicator(kline *model.BaseLine, lineA *indicator_base2.Line, lineB *indicator_base2.Line) *CrossOverIndicator {
...
//}
//
//func (coi *CrossOverIndicator) DoPlot(kline *charts.Line, ratioLine *charts.Line) {
