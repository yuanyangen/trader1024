...
//}
//
//func NewLineSmaIndicator(inline *model.BaseLine, period int64) *LineSmaIndicator {
...
//	}
//
//	out := talib.Sma(data_crawler, int(kama.erPeriod))
//	avg := out[len(out)-1]
...
//}
//func (kama *LineSmaIndicator) DoPlot(kline *charts.Line, ratioLine *charts.Line) {
