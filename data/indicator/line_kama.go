...
//}
//
//func NewLineKAMAIndicator(inline *model.BaseLine, period, shortPeriod, longPeriod int64) *LineKAMAIndicator {
...
//		return
//	}
//	data_crawler := utils.DataNodeSliceToFloat(dataI)
//	if len(data_crawler) == 0 {
//		kama.KAMALine.AddData(ts, 0)
//		return
//	}
...
//	out := talib.CustomKama(data_crawler, int(kama.erPeriod), int(kama.shortPeriod), int(kama.longPeriod), lastData)
//	avg := out[len(out)-1]
...
//}
//func (kama *LineKAMAIndicator) DoPlot(kline *charts.Line, ratioLine *charts.Line) {
