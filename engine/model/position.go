...
func (p *ContractPosition) Report() {
	...
	shortGain := 0.0
	winCount := 0
	logs.Info("########################data_crawler start ########################\n\n")
	logs.Info("ContractId StartTime EndTime PositionType BuyPrice BuyReason BuyTime SellPrice SellReason SellTime Count Result Gain")
