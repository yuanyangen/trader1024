...
//	//es.kama5 = indicator.NewKAMAIndicator(ec.Line, 2, 2, 5)
//	//es.kama5_kama3 = indicator.NewKAMAIndicator(es.kama5, 3, 5, 10)
//	//es.kama5_kama2 = indicator.NewKAMAIndicator(es.kama5, 2, 4, 6)
//	es.kamaFast = indicator.NewKAMAIndicator(ec.Line, 2, 5, 2)
//	es.kamaSlow = indicator.NewKAMAIndicator(ec.Line, 4, 5, 4)
//
...
//	//es.crossover = indicator.NewCrossOverIndicator(ec.Line, es.kamaFast.KAMALine, es.kamaFastKama.KAMALine)
//	//es.crossunder = indicator.NewCrossUnderIndicator(ec.Line, es.kamaFast.KAMALine, es.kamaFastKama.KAMALine)
//
...
//	//s := 0.01
//	slopPeriod := 10
//	currentKNode, err := ctx.Line.GetByTs(ts)
